    ...
    return (
        <div className="report-page">
            <div className="report-page-contents">
                ...
                <p className="report-page-paragraph" style={{marginTop: "96px"}}>We believe that the gender identity ratio obtained from our survey is fairly balanced for men and women, though we do wish we could have heard from more non-binary individuals. However, racial demographics were a different story. 80% of survey respondents were Asian, for example, with few if any Hispanic or Black or Native American individuals. This is likely due to the demographics of engineering departments at UCSD, where a majority of students are Asian. Nevertheless, we recognize that the racial makeup of survey respondents may not match society as a whole, which may make some results from the survey not perfectly representative of the real world.</p>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div>
                ...
                <p className="report-page-paragraph">Out of the three, we found that environmental microaggression occurs most frequently on campus, with an average of 4.05 in contrast to the other averages of 3.45 for verbal, and 3.18 for behavioral. Environmental microaggressions were also found to be statistically significant with a p-value of 0.0036. It appears that overall, people agree that there is a lack of representation and diversity on campus, especially in STEM programs. There is some basis to this, as we can see there are specific groups (African American, American Indian, Native Hawaiian / Pacific Islander) that are hardly represented at UCSD, even on their <a style={{textDecoration: 'underline', cursor: 'pointer'}} href="https://ir.ucsd.edu/undergrad/publications/6-25INORDER.pdf">Student Profile</a> for all undergraduates. This is further supported by the demographics in engineering at UCSD that can be found on their dashboard (<a target="_blank" rel="noopener noreferrer" style={{textDecoration: 'underline', cursor: 'pointer'}} href="https://diversity.ucsd.edu/accountability/undergrad.html">found here</a>).</p>
                <div>
                        <p style={{ fontSize: "16px", fontWeight: "700" }}>Interview Question: “Why do you think UCSD is prone to social biases? In other words, what do you think is an underlying issue that is still yet to be addressed?”</p>
                        <div style={{ backgroundColor: "#FFFEDD", width: "1028px", height: "148px", borderRadius: "15px", position: "relative" }}>
                            <img src="/placeholder-3.png" alt="Profile Placeholder 2" style={{ height: "100px", width: "100px", position: "absolute", top: "25px", left: "-50px" }}/>
